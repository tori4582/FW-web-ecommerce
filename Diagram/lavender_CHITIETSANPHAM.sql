...
CREATE TABLE `CHITIETSANPHAM` (
  ...
  PRIMARY KEY (`IMEI`),
  KEY `FK_REFERENCE_14` (`MASANPHAM`),
  CONSTRAINT `FK_REFERENCE_14` FOREIGN KEY (`MASANPHAM`) REFERENCES `SANPHAM` (`MASANPHAM`) ON DELETE RESTRICT ON UPDATE RESTRICT
...
INSERT INTO `CHITIETSANPHAM` VALUES ('1',1,'2021-09-15 00:00:00','Đã bán'),('2',1,'2021-11-01 00:00:00','Đã bán');
...
-- Dump completed on 2021-11-18 21:43:41
